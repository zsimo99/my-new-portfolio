        ...
        <section id="services" className="py-40 bg-[#0A4F51] text-white relative">
            <div className="container mx-auto p-4">
                <div className="relative hide duration-700 transition-[opacity,transform] ">
                    ...
                    <h2 className="text-3xl lg:text-4xl xl:text-5xl absolute w-full h-fit translate-y-[55%] bottom-0 left-0 font-extrabold text-[#40dcdf]  text-center opacity-30">What Im Great At</h2>
                </div>
