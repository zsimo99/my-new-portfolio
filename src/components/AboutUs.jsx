        ...
        >
            ...
            <div className="container mx-auto px-6 flex max-lg:flex-col-reverse gap-12 lg:gap-16 items-center relative z-10">
                ...
                <div className="lg:basis-1/2 space-y-6">
                    <span className="text-[#40dcdf] text-sm md:text-base font-semibold tracking-widest uppercase hide duration-700 transition-all">Get to know me</span>
                    ...
                    <p className="text-base md:text-lg xl:text-xl text-gray-300 leading-relaxed hide duration-700 transition-all">
                        As an individual, I&apos;m Mohamed, and I take great pride in crafting digital experiences that leave a lasting impact. With a keen eye for aesthetics and a passion for innovation, I transform concepts into captivating websites and powerful web applications. My commitment to quality and creativity has earned me a reputation for turning ideas into reality. Explore my portfolio to witness the expertise and dedication that define my work.
                    </p>
                </div>
            </div>
            <div className="container mx-auto px-6 mt-12">
                <a target="_blank" rel="noreferrer" href="https://www.fiverr.com/mohamedzoraa" className="btn-glow hide duration-700 transition-all px-8 py-3 md:px-12 md:py-4 block w-fit ms-auto rounded-lg text-lg md:text-xl font-bold text-white bg-gradient-to-r from-[#309092] to-[#40dcdf] shadow-lg shadow-[#30909030]">
                    Hire Me
                </a>
            </div>
        </section>
